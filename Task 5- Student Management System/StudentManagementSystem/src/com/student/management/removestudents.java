...
public class removestudents extends JFrame implements ActionListener {
	...
	removestudents(){
		 setIconImage(Toolkit.getDefaultToolkit().getImage(removestudents.class.getResource("/Gallery/icon.png")));
		 getContentPane().setBackground(Color.green);
		 setResizable(false);
		 setLayout(null);
		
		 JLabel title=new JLabel("Remove Student Details");
		 ...
		 delete.setBounds(700, 530, 150, 40);
		 ...
		 ImageIcon i1 = new ImageIcon(removestudents.class.getResource("/Gallery/removesg.jpg"));
	      ...
	      if(e.getSource()==back) {
             setVisible(false);		
	    	  ...
	    	  String rollno=tfrollno.getSelectedItem();
				...
				try {
					Conn c=new Conn();
	            	c.s.executeUpdate("delete from addstudent where rollno ='"+rollno+"'");
